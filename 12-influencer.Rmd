...
load('data/ens-networks-example.RData')

par(mar=c(0,0,0,0)+.1) # to reduce the margins 

# code for the visualization of small network
plot(g_small, layout = layout_as_star, vertex.size = 20, 
     vertex.color = c('red', rep('blue', 5)), 
     vertex.label.color = 'white', vertex.label.cex = 3,
     edge.color = c(rep('lightgrey', 3), rep('black', 2), 
                    'lightgrey', 'black', 'lightgrey', rep('black', 4))
    )

# code for the visualization of large network

plot(g_large, layout = layout_as_star(g_large, center = 21), vertex.size = 20, 
     vertex.color = c(rep('blue', 20), 'red'), 
     vertex.label.color = 'white', vertex.label.cex = 2,
     edge.color = c(rep('black', 133), 
                     rep('lightgrey', 20))
    )
