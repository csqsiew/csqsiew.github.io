...
\begin{verbatim}
## IGRAPH f94f900 UN-- 2 1 -- 
## + attr: name (v/c)
## + edge from f94f900 (vertex names):
## [1] cat--bat
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 63b518e DN-- 2 1 -- 
## + attr: name (v/c)
## + edge from 63b518e (vertex names):
## [1] cat->bat
\end{verbatim}
...
\begin{verbatim}
## + 3/3 vertices, named, from c56fef4:
## [1] A B C
\end{verbatim}
...
\begin{verbatim}
## + 3/3 edges from c56fef4 (vertex names):
## [1] A->B B->C C->A
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 4b458a1 UNW- 34 78 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt
## | (v/c), age (v/n), weight (e/n)
\end{verbatim}
...
## IGRAPH 4b458a1 UNW- 34 78 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt
## | (v/c), age (v/n), weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
##  [1] "same"      "same"      "same"      "same"      "different" "same"      "same"      "same"      "same"      "different" "different"
## [12] "same"      "different" "same"      "same"      "different" "same"      "same"      "same"      "same"      "different" "same"     
## [23] "same"      "same"      "same"      "same"      "same"      "same"      "same"      "different" "same"      "different" "same"     
## [34] "different" "same"      "same"      "same"      "different" "different" "same"      "different" "same"      "different" "same"     
## [45] "same"      "same"      "same"      "different" "same"      "different" "different" "same"      "same"      "different" "same"     
## [56] "different" "same"      "same"      "different" "different" "different" "same"      "same"      "different" "different" "different"
## [67] "same"      "different" "different" "different" "same"      "same"      "different" "different" "same"      "same"      "different"
## [78] "different"
\end{verbatim}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-66-2.pdf}}
...
\begin{verbatim}
## IGRAPH 5fb5854 UNW- 12 6 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt
## | (v/c), age (v/n), weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 7394498 UNW- 10 21 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt
## | (v/c), age (v/n), weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH f752b4d UNW- 26 59 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt
## | (v/c), age (v/n), weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH cd3ef21 DNW- 34 78 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt
## | (v/c), age (v/n), weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH fa7db54 DNW- 34 156 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt
## | (v/c), age (v/n), weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH c4dc855 DNW- 0 0 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt
## | (v/c), age (v/n), weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH b51d3d7 DNW- 34 156 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt
## | (v/c), age (v/n), weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 33c79fd DNW- 34 78 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt
## | (v/c), age (v/n), weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH d6e51ca DNW- 0 0 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt
## | (v/c), age (v/n), weight (e/n), edge_type (e/c)
\end{verbatim}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/shortest-path.jpeg}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/small-world.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/density.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/diameter.png}}
...
##       16        9       10        6        3        4        4        5        2        5        2        2        2        3        2 
...
##        2        5        3        3        2        4        3        4        4        6       12        4        3        1        2 
...
\pandocbounded{\includegraphics[keepaspectratio]{images/in_out_degree.jpg}}
...
\begin{verbatim}
##    Mr Hi  Actor 2  Actor 3  Actor 4  Actor 5  Actor 6  Actor 7  Actor 9 Actor 10 Actor 14 Actor 15 Actor 16 Actor 19 Actor 20 Actor 21 
##       45       23       33       16        4       12       11       16        5       17        6        7        5        9        2 
## Actor 23 Actor 24 Actor 25 Actor 26 Actor 27 Actor 28 Actor 29 Actor 30 Actor 31 Actor 32 Actor 33  Actor 8 Actor 11 Actor 12 Actor 13 
##        9       22       11        7        4       13        9       12       11       17       31        8        5        1        7 
## Actor 18 Actor 22 Actor 17   John A 
##        7        3        5       53
\end{verbatim}
...
\pandocbounded{\includegraphics[keepaspectratio]{images/hcc-lcc.jpg}}
...
## 0.1500000 0.3333333 0.2444444 0.6666667 0.6666667 0.5000000 0.5000000 0.5000000 0.0000000 0.6000000 1.0000000 1.0000000 1.0000000 
##  Actor 20  Actor 21  Actor 23  Actor 24  Actor 25  Actor 26  Actor 27  Actor 28  Actor 29  Actor 30  Actor 31  Actor 32  Actor 33 
## 0.3333333 1.0000000 1.0000000 0.4000000 0.3333333 0.3333333 1.0000000 0.1666667 0.3333333 0.6666667 0.5000000 0.2000000 0.1969697 
##   Actor 8  Actor 11  Actor 12  Actor 13  Actor 18  Actor 22  Actor 17    John A 
## 1.0000000 0.6666667 0.0000000 1.0000000 1.0000000 1.0000000 1.0000000 0.1102941
\end{verbatim}
...
## 0.3333333 1.0000000 1.0000000 0.4000000 0.3333333 0.3333333 1.0000000 0.1666667 0.3333333 0.6666667 0.5000000 0.2000000 0.1969697 
##   Actor 8  Actor 11  Actor 12  Actor 13  Actor 18  Actor 22  Actor 17    John A 
## 1.0000000 0.6666667       NaN 1.0000000 1.0000000 1.0000000 1.0000000 0.1102941
\end{verbatim}
...
## 0.13629630 0.31521739 0.25925926 0.63750000 0.75000000 0.58333333 0.54545455 0.48437500 0.00000000 0.70588235 1.00000000 1.00000000 
##   Actor 19   Actor 20   Actor 21   Actor 23   Actor 24   Actor 25   Actor 26   Actor 27   Actor 28   Actor 29   Actor 30   Actor 31 
## 1.00000000 0.22222222 1.00000000 1.00000000 0.38636364 0.27272727 0.14285714 1.00000000 0.15384615 0.27777778 0.75000000 0.60606061 
##   Actor 32   Actor 33    Actor 8   Actor 11   Actor 12   Actor 13   Actor 18   Actor 22   Actor 17     John A 
## 0.16470588 0.15542522 1.00000000 0.80000000        NaN 1.00000000 1.00000000 1.00000000 1.00000000 0.09669811
\end{verbatim}
...
\begin{verbatim}
##     Mr Hi   Actor 2   Actor 3   Actor 4   Actor 5   Actor 6   Actor 7   Actor 9  Actor 10  Actor 14  Actor 15  Actor 16  Actor 19 
## 0.2771084 0.2051282 0.2666667 0.2666667 0.5000000 0.4285714 0.3333333 0.4285714 0.5000000 1.0000000 0.3333333 0.2857143 0.6666667 
##  Actor 20  Actor 21  Actor 23  Actor 24  Actor 25  Actor 26  Actor 27  Actor 28  Actor 29  Actor 30  Actor 31  Actor 32  Actor 33 
## 0.2000000 1.0000000 0.2222222 0.2142857 0.3125000 0.4285714 0.4285714 0.5000000 0.3333333 0.4000000 0.2857143 0.5000000 1.0000000 
##   Actor 8  Actor 11  Actor 12  Actor 13  Actor 18  Actor 22  Actor 17    John A 
...
\begin{verbatim}
##     Mr Hi   Actor 2   Actor 3   Actor 4   Actor 5   Actor 6   Actor 7   Actor 9  Actor 10  Actor 14  Actor 15  Actor 16  Actor 19 
## 0.7666667 0.6400000 0.7500000 0.8000000 0.7500000 1.0000000 1.0000000 1.0000000 1.0000000 1.0000000 1.0000000 1.0000000 1.0000000 
##  Actor 20  Actor 21  Actor 23  Actor 24  Actor 25  Actor 26  Actor 27  Actor 28  Actor 29  Actor 30  Actor 31  Actor 32  Actor 33 
## 1.0000000 1.0000000 1.0000000 0.8571429 0.7142857 0.6000000 0.7500000 1.0000000 0.7500000 1.0000000 1.0000000 1.0000000 1.0000000 
##   Actor 8  Actor 11  Actor 12  Actor 13  Actor 18  Actor 22  Actor 17    John A 
##       NaN       NaN       NaN       NaN       NaN       NaN       NaN       NaN
\end{verbatim}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-110-1.pdf}}
...
\begin{verbatim}
## [[1]]
## + 4/5 vertices, named, from 835c817:
## [1] A D E C
\end{verbatim}
...
\begin{verbatim}
## [[1]]
## + 3/5 vertices, named, from 835c817:
## [1] A B C
\end{verbatim}
...
## 0.0000000000 0.0021306818 0.0075757576 0.0040246212 0.0014204545 0.0000000000 0.0018939394 0.0016571970 0.0000000000 0.0023674242 
##     Actor 15     Actor 16     Actor 19     Actor 20     Actor 21     Actor 23     Actor 24     Actor 25     Actor 26     Actor 27 
## 0.0000000000 0.0000000000 0.0000000000 0.0000000000 0.0000000000 0.0000000000 0.0000000000 0.0000000000 0.0037878788 0.0000000000 
##     Actor 28     Actor 29     Actor 30     Actor 31     Actor 32     Actor 33      Actor 8     Actor 11     Actor 12     Actor 13 
## 0.0000000000 0.0018939394 0.0009469697 0.0026041667 0.0047348485 0.0056818182 0.0000000000 0.0000000000 0.0000000000 0.0000000000 
##     Actor 18     Actor 22     Actor 17       John A 
...
\begin{verbatim}
##        Mr Hi      Actor 2      Actor 3      Actor 4      Actor 5      Actor 6      Actor 7      Actor 9     Actor 10     Actor 14 
## 0.0000000000 0.0004734848 0.0083648990 0.0018939394 0.0000000000 0.0004734848 0.0014204545 0.0021306818 0.0001578283 0.0016571970 
##     Actor 15     Actor 16     Actor 19     Actor 20     Actor 21     Actor 23     Actor 24     Actor 25     Actor 26     Actor 27 
## 0.0000000000 0.0000000000 0.0000000000 0.0005523990 0.0000000000 0.0000000000 0.0000000000 0.0000000000 0.0009469697 0.0000000000 
##     Actor 28     Actor 29     Actor 30     Actor 31     Actor 32     Actor 33      Actor 8     Actor 11     Actor 12     Actor 13 
## 0.0006313131 0.0020517677 0.0009469697 0.0007891414 0.0048137626 0.0001578283 0.0000000000 0.0000000000 0.0000000000 0.0000000000 
##     Actor 18     Actor 22     Actor 17       John A 
## 0.0000000000 0.0000000000 0.0000000000 0.0000000000
\end{verbatim}
...
## 0.096997285 0.052876924 0.057078509 0.035859858 0.021977952 0.029111155 0.029111155 0.029766056 0.014309397 0.029536456 0.014535994 
##    Actor 16    Actor 19    Actor 20    Actor 21    Actor 23    Actor 24    Actor 25    Actor 26    Actor 27    Actor 28    Actor 29 
## 0.014535994 0.014535994 0.019604636 0.014535994 0.014535994 0.031522515 0.021076034 0.021006197 0.015044038 0.025639767 0.019573459 
##    Actor 30    Actor 31    Actor 32    Actor 33     Actor 8    Actor 11    Actor 12    Actor 13    Actor 18    Actor 22    Actor 17 
## 0.026288538 0.024590155 0.037158087 0.071693226 0.024490497 0.021977952 0.009564745 0.014644892 0.014558677 0.014558677 0.016784005 
##      John A 
## 0.100919182
\end{verbatim}
...
\begin{verbatim}
##      Mr Hi    Actor 2    Actor 3    Actor 4    Actor 5    Actor 6    Actor 7    Actor 9   Actor 10   Actor 14   Actor 15   Actor 16 
## 0.01523537 0.01552315 0.01938528 0.01886916 0.01581093 0.01667427 0.03091729 0.01884496 0.01729506 0.02746170 0.01523537 0.01523537 
##   Actor 19   Actor 20   Actor 21   Actor 23   Actor 24   Actor 25   Actor 26   Actor 27   Actor 28   Actor 29   Actor 30   Actor 31 
## 0.01523537 0.01701045 0.01523537 0.01523537 0.01523537 0.01523537 0.01935585 0.01523537 0.02484945 0.01798162 0.02141609 0.01939474 
##   Actor 32   Actor 33    Actor 8   Actor 11   Actor 12   Actor 13   Actor 18   Actor 22   Actor 17     John A 
## 0.04512689 0.08402038 0.02351277 0.02484309 0.01552315 0.01988203 0.01880972 0.01672267 0.04556454 0.26808640
\end{verbatim}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-127-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-133-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-135-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-136-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-137-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-137-2.pdf}}
...
\begin{verbatim}
## IGRAPH 7871106 U--- 10 20 -- Watts-Strogatz random graph
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-138-1.pdf}}
...
\begin{verbatim}
## IGRAPH 0c42d88 U--- 10 20 -- Watts-Strogatz random graph
## + attr: name (g/c), dim (g/n), size (g/n), nei (g/n), p (g/n), loops (g/l), multiple (g/l)
\end{verbatim}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-139-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-141-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-141-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-141-3.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-142-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-143-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-143-2.pdf}}
...
##  [1] spike --speak  spike --spoke  spike --speck  spike --spook  spoke --spook  spoke --speck  speak --spoke  speck --spook  speak --spook 
## [10] speak --speck  speck --sped   sped  --speed  sped  --spud   speed --spud   speed --stead  speed --seed   speed --speech speak --speed 
## [19] stead --seed   seed  --seek   seek  --sneak  seek  --sleek  speak --seek   seek  --peek   sneak --sleek  speak --sneak  speak --sleek 
## [28] speak --peek   speak --speech speech--peach  peach --peace  peek  --peach  peach --peep   peach --pea    peach --peat   peach --peel  
## [37] peach --peas   peach --teach  peach --leach  peach --beach  peach --each   peach --pouch  peach --pitch  peach --patch  peach --pooch 
## [46] peach --poach  peach --preach peach --reach  pea   --peas   pea   --peel   peep  --pea    peek  --pea    peace --pea    pea   --peat  
## [55] peep  --peel   peep  --peas   peep  --peat   peace --peep   peek  --peep   peel  --peas   peat  --peel   peace --peel   peek  --peel  
## [64] peat  --peas   peace --peas   peek  --peas   peek  --peat   peek  --peace  peace --peat   teach --leach  leach --reach  leach --each  
...
\begin{verbatim}
##           V1           V2           V3          V3A           V4          V4t          VOT           VP           MT       MSTd/p 
## 0.0003156566 0.0003310887 0.0002976190 0.0003108003 0.0005071549 0.0003282828 0.0002693603 0.0002976190 0.0002946128 0.0002921371 
##         MSTl           PO          LIP          PIP          VIP           DP           7a          FST         PITd         PITv 
## 0.0003328742 0.0002861953 0.0003135522 0.0003507295 0.0005250922 0.0003086420 0.0003900112 0.0002702463 0.0003367003 0.0002840909 
##         CITd         CITv         AITd         AITv         STPp         STPa           TF           TH          FEF           46 
## 0.0004349046 0.0003682660 0.0003198653 0.0003848004 0.0003661616 0.0004377104 0.0004307784 0.0003437149 0.0003979186 0.0004861111 
##           3a           3b            1            2            5           Ri          SII           7b            4            6 
## 0.0004349046 0.0004629630 0.0003787879 0.0003749617 0.0003979186 0.0004103535 0.0005536131 0.0003561254 0.0003114478 0.0003137435 
##          SMA           Ig           Id           35           36 
## 0.0003156566 0.0004278900 0.0004945286 0.0005471380 0.0005611672
\end{verbatim}
...
##  2.000000  6.200000  5.428571  4.076923 12.900000  3.200000  3.000000  6.000000  6.125000  7.941176  4.272727  5.933333 10.700000 
##       PIP       VIP        DP        7a       FST      PITd      PITv      CITd      CITv      AITd      AITv      STPp      STPa 
##  3.888889 12.333333  4.833333  8.866667 10.157895  5.250000  6.666667  3.000000  3.750000  5.600000  3.000000  6.400000  1.800000 
##        TF        TH       FEF        46        3a        3b         1         2         5        Ri       SII        7b         4 
## 11.941176  7.333333 13.454545 13.900000  2.000000  1.000000  2.750000  4.636364  5.181818  1.500000  7.615385  6.538462  4.200000 
##         6       SMA        Ig        Id        35        36 
##  4.272727  2.750000  4.000000  2.500000  3.000000  4.666667
\end{verbatim}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-158-1.pdf}} \pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-158-2.pdf}}
...
\begin{verbatim}
## # A tibble: 3 x 5
##   `AVOID REMINDERS OF THE TRAUMA` `BAD DREAMS ABOUT THE TRAUMA` `BEING JUMPY OR EASILY STARTLED` `BEING OVER ALERT` DISTANT OR CUT OFF FR~1
##                             <dbl>                         <dbl>                            <dbl>              <dbl>                   <dbl>
## 1                               4                             1                                4                  4                       1
## 2                               1                             3                                2                  3                       1
## 3                               4                             2                                1                  2                       2
## # i abbreviated name: 1: `DISTANT OR CUT OFF FROM PEOPLE`
\end{verbatim}
...
\begin{verbatim}
##            AROTT      BDATT      BJOES       BOA    DOCOFP       FEN       FEI     FPWCT        HTC       HTS      LIIA      NATR
## AROTT  0.0000000  0.0000000  0.0000000 0.1555554 0.0000000 0.0000000 0.0000000 0.0000000  0.0000000 0.0000000 0.0000000 0.0000000
## BDATT  0.0000000  0.0000000  0.0000000 0.0000000 0.0000000 0.0000000 0.0000000 0.0000000 -0.1221041 0.0000000 0.0000000 0.0000000
## BJOES  0.0000000  0.0000000  0.0000000 0.4075190 0.0000000 0.0000000 0.0000000 0.0000000  0.0000000 0.0000000 0.1129132 0.0000000
## BOA    0.1555554  0.0000000  0.4075190 0.0000000 0.0000000 0.1423142 0.0000000 0.0000000  0.0000000 0.0000000 0.0000000 0.0000000
## DOCOFP 0.0000000  0.0000000  0.0000000 0.0000000 0.0000000 0.2357181 0.1334469 0.0000000  0.0000000 0.0000000 0.3509726 0.0000000
## FEN    0.0000000  0.0000000  0.0000000 0.1423142 0.2357181 0.0000000 0.1410481 0.1474119  0.0000000 0.0000000 0.0000000 0.0000000
## FEI    0.0000000  0.0000000  0.0000000 0.0000000 0.1334469 0.1410481 0.0000000 0.1214582  0.1793871 0.0000000 0.0000000 0.0000000
## FPWCT  0.0000000  0.0000000  0.0000000 0.0000000 0.0000000 0.1474119 0.1214582 0.0000000  0.0000000 0.0000000 0.2044012 0.0000000
## HTC    0.0000000 -0.1221041  0.0000000 0.0000000 0.0000000 0.0000000 0.1793871 0.0000000  0.0000000 0.1332300 0.0000000 0.0000000
## HTS    0.0000000  0.0000000  0.0000000 0.0000000 0.0000000 0.0000000 0.0000000 0.0000000  0.1332300 0.0000000 0.0000000 0.0000000
## LIIA   0.0000000  0.0000000  0.1129132 0.0000000 0.3509726 0.0000000 0.0000000 0.2044012  0.0000000 0.0000000 0.0000000 0.0000000
## NATR   0.0000000  0.0000000  0.0000000 0.0000000 0.0000000 0.0000000 0.0000000 0.0000000  0.0000000 0.0000000 0.0000000 0.0000000
## NTAT   0.1515577  0.0000000  0.1204094 0.0000000 0.0000000 0.0000000 0.0000000 0.0000000  0.0000000 0.0000000 0.0000000 0.1711055
## PHR    0.1746399  0.1089284  0.1692879 0.0000000 0.0000000 0.0000000 0.0000000 0.0000000  0.0000000 0.0000000 0.0000000 0.0000000
## RTT    0.0000000  0.0000000  0.0000000 0.0000000 0.0000000 0.0000000 0.0000000 0.0000000  0.0000000 0.0000000 0.1093724 0.1487162
## UWROT  0.0000000  0.1461690 -0.1109757 0.0000000 0.0000000 0.0000000 0.0000000 0.0000000  0.0000000 0.0000000 0.0000000 0.1546641
## UTOI   0.0000000  0.1710409  0.0000000 0.0000000 0.0000000 0.0000000 0.0000000 0.0000000  0.0000000 0.1351728 0.0000000 0.0000000
##             NTAT       PHR       RTT      UWROT      UTOI
## AROTT  0.1515577 0.1746399 0.0000000  0.0000000 0.0000000
## BDATT  0.0000000 0.1089284 0.0000000  0.1461690 0.1710409
## BJOES  0.1204094 0.1692879 0.0000000 -0.1109757 0.0000000
## BOA    0.0000000 0.0000000 0.0000000  0.0000000 0.0000000
## DOCOFP 0.0000000 0.0000000 0.0000000  0.0000000 0.0000000
## FEN    0.0000000 0.0000000 0.0000000  0.0000000 0.0000000
## FEI    0.0000000 0.0000000 0.0000000  0.0000000 0.0000000
## FPWCT  0.0000000 0.0000000 0.0000000  0.0000000 0.0000000
## HTC    0.0000000 0.0000000 0.0000000  0.0000000 0.0000000
## HTS    0.0000000 0.0000000 0.0000000  0.0000000 0.1351728
## LIIA   0.0000000 0.0000000 0.1093724  0.0000000 0.0000000
## NATR   0.1711055 0.0000000 0.1487162  0.1546641 0.0000000
## NTAT   0.0000000 0.0000000 0.0000000  0.1169038 0.0000000
## PHR    0.0000000 0.0000000 0.1811024  0.0000000 0.0000000
## RTT    0.0000000 0.1811024 0.0000000  0.0000000 0.1970405
## UWROT  0.1169038 0.0000000 0.0000000  0.0000000 0.4497070
## UTOI   0.0000000 0.0000000 0.1970405  0.4497070 0.0000000
\end{verbatim}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/test-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-170-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-171-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-172-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-172-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-173-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-174-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-174-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-175-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-176-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-177-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-177-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-178-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-179-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-180-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-180-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-181-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-182-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-183-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-187-1.pdf}}
...
\begin{verbatim}
## Expected total run time for 1000 sims, using 4 threads is 401 seconds.
\end{verbatim}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-188-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-188-2.pdf}}
