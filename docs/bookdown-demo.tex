...
\begin{verbatim}
## IGRAPH e4b7992 UN-- 2 1 -- 
## + attr: name (v/c)
## + edge from e4b7992 (vertex names):
## [1] cat--bat
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 6c40a9f DN-- 2 1 -- 
## + attr: name (v/c)
## + edge from 6c40a9f (vertex names):
## [1] cat->bat
\end{verbatim}
...
\begin{verbatim}
## + 3/3 vertices, named, from 8d974e0:
## [1] A B C
\end{verbatim}
...
\begin{verbatim}
## + 3/3 edges from 8d974e0 (vertex names):
## [1] A->B B->C C->A
\end{verbatim}
...
\begin{verbatim}
## IGRAPH ba30ec7 UNW- 12 6 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt (v/c), age (v/n), weight
## | (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH d118f3a UNW- 10 21 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt (v/c), age (v/n), weight
## | (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 552d6ff UNW- 26 59 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt (v/c), age (v/n), weight
## | (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 8d3c933 DNW- 34 78 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt (v/c), age (v/n), weight
## | (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH ab520e8 DNW- 34 156 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt (v/c), age (v/n), weight
## | (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 11e2f74 DNW- 0 0 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt (v/c), age (v/n), weight
## | (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH c5c8233 DNW- 34 156 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt (v/c), age (v/n), weight
## | (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 8de7dc3 DNW- 34 78 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt (v/c), age (v/n), weight
## | (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 7b54542 DNW- 0 0 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt (v/c), age (v/n), weight
## | (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## [[1]]
## + 4/5 vertices, named, from b2b6ef8:
## [1] A D E C
\end{verbatim}
...
\begin{verbatim}
## [[1]]
## + 3/5 vertices, named, from b2b6ef8:
## [1] A B C
\end{verbatim}
...
## 0.0000000000 0.0021306818 0.0075757576 0.0040246212 0.0014204545 0.0000000000 0.0018939394 0.0016571970 0.0000000000 0.0023674242 0.0000000000 0.0000000000 
##     Actor 19     Actor 20     Actor 21     Actor 23     Actor 24     Actor 25     Actor 26     Actor 27     Actor 28     Actor 29     Actor 30     Actor 31 
## 0.0000000000 0.0000000000 0.0000000000 0.0000000000 0.0000000000 0.0000000000 0.0037878788 0.0000000000 0.0000000000 0.0018939394 0.0009469697 0.0026041667 
##     Actor 32     Actor 33      Actor 8     Actor 11     Actor 12     Actor 13     Actor 18     Actor 22     Actor 17       John A 
## 0.0047348485 0.0056818182 0.0000000000 0.0000000000 0.0000000000 0.0000000000 0.0000000000 0.0000000000 0.0000000000 0.0000000000
\end{verbatim}
...
\begin{verbatim}
##        Mr Hi      Actor 2      Actor 3      Actor 4      Actor 5      Actor 6      Actor 7      Actor 9     Actor 10     Actor 14     Actor 15     Actor 16 
## 0.0000000000 0.0004734848 0.0083648990 0.0018939394 0.0000000000 0.0004734848 0.0014204545 0.0021306818 0.0001578283 0.0016571970 0.0000000000 0.0000000000 
##     Actor 19     Actor 20     Actor 21     Actor 23     Actor 24     Actor 25     Actor 26     Actor 27     Actor 28     Actor 29     Actor 30     Actor 31 
## 0.0000000000 0.0005523990 0.0000000000 0.0000000000 0.0000000000 0.0000000000 0.0009469697 0.0000000000 0.0006313131 0.0020517677 0.0009469697 0.0007891414 
##     Actor 32     Actor 33      Actor 8     Actor 11     Actor 12     Actor 13     Actor 18     Actor 22     Actor 17       John A 
## 0.0048137626 0.0001578283 0.0000000000 0.0000000000 0.0000000000 0.0000000000 0.0000000000 0.0000000000 0.0000000000 0.0000000000
\end{verbatim}
...
## 0.096997285 0.052876924 0.057078509 0.035859858 0.021977952 0.029111155 0.029111155 0.029766056 0.014309397 0.029536456 0.014535994 0.014535994 0.014535994 
##    Actor 20    Actor 21    Actor 23    Actor 24    Actor 25    Actor 26    Actor 27    Actor 28    Actor 29    Actor 30    Actor 31    Actor 32    Actor 33 
## 0.019604636 0.014535994 0.014535994 0.031522515 0.021076034 0.021006197 0.015044038 0.025639767 0.019573459 0.026288538 0.024590155 0.037158087 0.071693226 
##     Actor 8    Actor 11    Actor 12    Actor 13    Actor 18    Actor 22    Actor 17      John A 
## 0.024490497 0.021977952 0.009564745 0.014644892 0.014558677 0.014558677 0.016784005 0.100919182
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 9a134d2 U--- 10 20 -- Watts-Strogatz random graph
...
\begin{verbatim}
## IGRAPH b9cac70 U--- 10 20 -- Watts-Strogatz random graph
## + attr: name (g/c), dim (g/n), size (g/n), nei (g/n), p (g/n), loops (g/l), multiple (g/l)
\end{verbatim}
...
##  [1] spike --speak  spike --spoke  spike --speck  spike --spook  spoke --spook  spoke --speck  speak --spoke  speck --spook  speak --spook  speak --speck 
## [11] speck --sped   sped  --speed  sped  --spud   speed --spud   speed --stead  speed --seed   speed --speech speak --speed  stead --seed   seed  --seek  
## [21] seek  --sneak  seek  --sleek  speak --seek   seek  --peek   sneak --sleek  speak --sneak  speak --sleek  speak --peek   speak --speech speech--peach 
## [31] peach --peace  peek  --peach  peach --peep   peach --pea    peach --peat   peach --peel   peach --peas   peach --teach  peach --leach  peach --beach 
## [41] peach --each   peach --pouch  peach --pitch  peach --patch  peach --pooch  peach --poach  peach --preach peach --reach  pea   --peas   pea   --peel  
## [51] peep  --pea    peek  --pea    peace --pea    pea   --peat   peep  --peel   peep  --peas   peep  --peat   peace --peep   peek  --peep   peel  --peas  
## [61] peat  --peel   peace --peel   peek  --peel   peat  --peas   peace --peas   peek  --peas   peek  --peat   peek  --peace  peace --peat   teach --leach 
## [71] leach --reach  leach --each   leach --beach  teach --beach  teach --each   teach --reach  beach --each   beach --reach  each  --reach  preach--reach 
...
\begin{verbatim}
##           V1           V2           V3          V3A           V4          V4t          VOT           VP           MT       MSTd/p         MSTl           PO 
## 0.0003156566 0.0003310887 0.0002976190 0.0003108003 0.0005071549 0.0003282828 0.0002693603 0.0002976190 0.0002946128 0.0002921371 0.0003328742 0.0002861953 
##          LIP          PIP          VIP           DP           7a          FST         PITd         PITv         CITd         CITv         AITd         AITv 
## 0.0003135522 0.0003507295 0.0005250922 0.0003086420 0.0003900112 0.0002702463 0.0003367003 0.0002840909 0.0004349046 0.0003682660 0.0003198653 0.0003848004 
##         STPp         STPa           TF           TH          FEF           46           3a           3b            1            2            5           Ri 
## 0.0003661616 0.0004377104 0.0004307784 0.0003437149 0.0003979186 0.0004861111 0.0004349046 0.0004629630 0.0003787879 0.0003749617 0.0003979186 0.0004103535 
##          SII           7b            4            6          SMA           Ig           Id           35           36 
## 0.0005536131 0.0003561254 0.0003114478 0.0003137435 0.0003156566 0.0004278900 0.0004945286 0.0005471380 0.0005611672
\end{verbatim}
...
\begin{verbatim}
##  [1] "AVOID REMINDERS OF THE TRAUMA"  "BAD DREAMS ABOUT THE TRAUMA"    "BEING JUMPY OR EASILY STARTLED" "BEING OVER ALERT"              
##  [5] "DISTANT OR CUT OFF FROM PEOPLE" "FEELING EMOTIONALLY NUMB"       "FEELING IRRITABLE"              "FEELING PLANS WONT COME TRUE"  
##  [9] "HAVING TROUBLE CONCENTRATING"   "HAVING TROUBLE SLEEPING"        "LESS INTEREST IN ACTIVITIES"    "NOT ABLE TO REMEMBER"          
## [13] "NOT THINKING ABOUT TRAUMA"      "PHYSICAL REACTIONS"             "RELIVING THE TRAUMA"            "UPSET WHEN REMINDED OF TRAUMA" 
