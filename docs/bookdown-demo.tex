...
\begin{verbatim}
## [[1]]
## + 4/5 vertices, named, from 9ac82f5:
## [1] A D E C
\end{verbatim}
...
\NormalTok{results}\SpecialCharTok{$}\NormalTok{centrality}\SpecialCharTok{/}\FunctionTok{gorder}\NormalTok{(macaque) }
\end{Highlighting}
\end{Shaded}
...
\includegraphics{bookdown-demo_files/figure-latex/unnamed-chunk-132-2.pdf}
