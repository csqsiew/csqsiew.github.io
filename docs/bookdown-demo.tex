...
\begin{verbatim}
## IGRAPH 657272b UN-- 2 1 -- 
## + attr: name (v/c)
## + edge from 657272b (vertex names):
## [1] cat--bat
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 5507484 DN-- 2 1 -- 
## + attr: name (v/c)
## + edge from 5507484 (vertex names):
## [1] cat->bat
\end{verbatim}
...
\begin{verbatim}
## + 3/3 vertices, named, from e01311d:
## [1] A B C
\end{verbatim}
...
\begin{verbatim}
## + 3/3 edges from e01311d (vertex names):
## [1] A->B B->C C->A
\end{verbatim}
...
\begin{verbatim}
## IGRAPH c444512 UNW- 12 6 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt
## | (v/c), age (v/n), weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH e92b566 UNW- 10 21 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt
## | (v/c), age (v/n), weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 3d8ea80 UNW- 26 59 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt
## | (v/c), age (v/n), weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 2968c0a DNW- 34 78 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt
## | (v/c), age (v/n), weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 7b58e96 DNW- 34 156 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt
## | (v/c), age (v/n), weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 67dd2d0 DNW- 0 0 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt
## | (v/c), age (v/n), weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 9529455 DNW- 34 156 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt
## | (v/c), age (v/n), weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 2e234aa DNW- 34 78 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt
## | (v/c), age (v/n), weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH f4bd0a2 DNW- 0 0 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt
## | (v/c), age (v/n), weight (e/n), edge_type (e/c)
\end{verbatim}
...
## 0.1500000 0.3333333 0.2444444 0.6666667 0.6666667 0.5000000 0.5000000 0.5000000 0.0000000 0.6000000 1.0000000 1.0000000 1.0000000 0.3333333 
...
## 1.0000000 1.0000000 0.4000000 0.3333333 0.3333333 1.0000000 0.1666667 0.3333333 0.6666667 0.5000000 0.2000000 0.1969697 1.0000000 0.6666667 
##  Actor 12  Actor 13  Actor 18  Actor 22  Actor 17    John A 
## 0.0000000 1.0000000 1.0000000 1.0000000 1.0000000 0.1102941
\end{verbatim}
...
## 1.0000000 1.0000000 0.4000000 0.3333333 0.3333333 1.0000000 0.1666667 0.3333333 0.6666667 0.5000000 0.2000000 0.1969697 1.0000000 0.6666667 
##  Actor 12  Actor 13  Actor 18  Actor 22  Actor 17    John A 
##       NaN 1.0000000 1.0000000 1.0000000 1.0000000 0.1102941
\end{verbatim}
...
\begin{verbatim}
##     Mr Hi   Actor 2   Actor 3   Actor 4   Actor 5   Actor 6   Actor 7   Actor 9  Actor 10  Actor 14  Actor 15  Actor 16  Actor 19  Actor 20 
## 0.2771084 0.2051282 0.2666667 0.2666667 0.5000000 0.4285714 0.3333333 0.4285714 0.5000000 1.0000000 0.3333333 0.2857143 0.6666667 0.2000000 
##  Actor 21  Actor 23  Actor 24  Actor 25  Actor 26  Actor 27  Actor 28  Actor 29  Actor 30  Actor 31  Actor 32  Actor 33   Actor 8  Actor 11 
## 1.0000000 0.2222222 0.2142857 0.3125000 0.4285714 0.4285714 0.5000000 0.3333333 0.4000000 0.2857143 0.5000000 1.0000000       NaN       NaN 
##  Actor 12  Actor 13  Actor 18  Actor 22  Actor 17    John A 
...
\begin{verbatim}
##     Mr Hi   Actor 2   Actor 3   Actor 4   Actor 5   Actor 6   Actor 7   Actor 9  Actor 10  Actor 14  Actor 15  Actor 16  Actor 19  Actor 20 
## 0.7666667 0.6400000 0.7500000 0.8000000 0.7500000 1.0000000 1.0000000 1.0000000 1.0000000 1.0000000 1.0000000 1.0000000 1.0000000 1.0000000 
##  Actor 21  Actor 23  Actor 24  Actor 25  Actor 26  Actor 27  Actor 28  Actor 29  Actor 30  Actor 31  Actor 32  Actor 33   Actor 8  Actor 11 
## 1.0000000 1.0000000 0.8571429 0.7142857 0.6000000 0.7500000 1.0000000 0.7500000 1.0000000 1.0000000 1.0000000 1.0000000       NaN       NaN 
##  Actor 12  Actor 13  Actor 18  Actor 22  Actor 17    John A 
##       NaN       NaN       NaN       NaN       NaN       NaN
\end{verbatim}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-104-1.pdf}}
...
\begin{verbatim}
## [[1]]
## + 4/5 vertices, named, from 5bee97d:
## [1] A D E C
\end{verbatim}
...
\begin{verbatim}
## [[1]]
## + 3/5 vertices, named, from 5bee97d:
## [1] A B C
\end{verbatim}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-121-1.pdf}}
...
\begin{verbatim}
##        V1        V2        V3       V3A        V4       V4t       VOT        VP        MT    MSTd/p      MSTl        PO       LIP       PIP 
##  2.000000  6.200000  5.428571  4.076923 12.900000  3.200000  3.000000  6.000000  6.125000  7.941176  4.272727  5.933333 10.700000  3.888889 
##       VIP        DP        7a       FST      PITd      PITv      CITd      CITv      AITd      AITv      STPp      STPa        TF        TH 
## 12.333333  4.833333  8.866667 10.157895  5.250000  6.666667  3.000000  3.750000  5.600000  3.000000  6.400000  1.800000 11.941176  7.333333 
##       FEF        46        3a        3b         1         2         5        Ri       SII        7b         4         6       SMA        Ig 
## 13.454545 13.900000  2.000000  1.000000  2.750000  4.636364  5.181818  1.500000  7.615385  6.538462  4.200000  4.272727  2.750000  4.000000 
##        Id        35        36 
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-138-1.pdf}} \pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-138-2.pdf}}
...
\begin{verbatim}
## # A tibble: 3 x 5
##   `AVOID REMINDERS OF THE TRAUMA` `BAD DREAMS ABOUT THE TRAUMA` `BEING JUMPY OR EASILY STARTLED` `BEING OVER ALERT` DISTANT OR CUT OFF FRO~1
##                             <dbl>                         <dbl>                            <dbl>              <dbl>                    <dbl>
## 1                               4                             1                                4                  4                        1
## 2                               1                             3                                2                  3                        1
## 3                               4                             2                                1                  2                        2
...
\begin{verbatim}
##            AROTT      BDATT      BJOES       BOA    DOCOFP       FEN       FEI     FPWCT        HTC       HTS      LIIA      NATR      NTAT
## AROTT  0.0000000  0.0000000  0.0000000 0.1555554 0.0000000 0.0000000 0.0000000 0.0000000  0.0000000 0.0000000 0.0000000 0.0000000 0.1515577
## BDATT  0.0000000  0.0000000  0.0000000 0.0000000 0.0000000 0.0000000 0.0000000 0.0000000 -0.1221041 0.0000000 0.0000000 0.0000000 0.0000000
## BJOES  0.0000000  0.0000000  0.0000000 0.4075190 0.0000000 0.0000000 0.0000000 0.0000000  0.0000000 0.0000000 0