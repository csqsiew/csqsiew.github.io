...
\begin{verbatim}
## IGRAPH 2e3c6f8 UN-- 2 1 -- 
## + attr: name (v/c)
## + edge from 2e3c6f8 (vertex names):
## [1] cat--bat
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 1e64021 DN-- 2 1 -- 
## + attr: name (v/c)
## + edge from 1e64021 (vertex names):
## [1] cat->bat
\end{verbatim}
...
\begin{verbatim}
## + 3/3 vertices, named, from 1ab9813:
## [1] A B C
\end{verbatim}
...
\begin{verbatim}
## + 3/3 edges from 1ab9813 (vertex names):
## [1] A->B B->C C->A
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 4b458a1 UNW- 34 78 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt (v/c), age (v/n),
## | weight (e/n)
\end{verbatim}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-45-2.pdf}}
...
\begin{verbatim}
## IGRAPH 6a4ccdc UNW- 12 6 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt (v/c), age (v/n),
## | weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 08721ae UNW- 10 21 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt (v/c), age (v/n),
## | weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 837bada UNW- 26 59 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt (v/c), age (v/n),
## | weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH ac23ec8 DNW- 34 78 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt (v/c), age (v/n),
## | weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH c3d7da3 DNW- 34 156 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt (v/c), age (v/n),
## | weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 3577770 DNW- 0 0 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt (v/c), age (v/n),
## | weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 6f89c8a DNW- 34 156 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt (v/c), age (v/n),
## | weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH f2da895 DNW- 34 78 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt (v/c), age (v/n),
## | weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
## IGRAPH 7ee9077 DNW- 0 0 -- Zachary's karate club network
## + attr: name (g/c), Citation (g/c), Author (g/c), Faction (v/n), name (v/c), label (v/c), color (v/n), gender (v/c), belt (v/c), age (v/n),
## | weight (e/n), edge_type (e/c)
\end{verbatim}
...
\begin{verbatim}
##    Mr Hi  Actor 2  Actor 3  Actor 4  Actor 5  Actor 6  Actor 7  Actor 9 Actor 10 Actor 14 Actor 15 Actor 16 Actor 19 Actor 20 Actor 21 Actor 23 Actor 24 
##       16        9       10        6        3        4        4        5        2        5        2        2        2        3        2        2        5 
## Actor 25 Actor 26 Actor 27 Actor 28 Actor 29 Actor 30 Actor 31 Actor 32 Actor 33  Actor 8 Actor 11 Actor 12 Actor 13 Actor 18 Actor 22 Actor 17   John A 
##        3        3        2        4        3        4        4        6       12        4        3        1        2        2        2        2       17
\end{verbatim}
...
\begin{verbatim}
##    Mr Hi  Actor 2  Actor 3  Actor 4  Actor 5  Actor 6  Actor 7  Actor 9 Actor 10 Actor 14 Actor 15 Actor 16 Actor 19 Actor 20 Actor 21 Actor 23 Actor 24 
##       45       23       33       16        4       12       11       16        5       17        6        7        5        9        2        9       22 
## Actor 25 Actor 26 Actor 27 Actor 28 Actor 29 Actor 30 Actor 31 Actor 32 Actor 33  Actor 8 Actor 11 Actor 12 Actor 13 Actor 18 Actor 22 Actor 17   John A 
##       11        7        4       13        9       12       11       17       31        8        5        1        7        7        3        5       53
\end{verbatim}
...
## 0.13629630 0.31521739 0.25925926 0.63750000 0.75000000 0.58333333 0.54545455 0.48437500 0.00000000 0.70588235 1.00000000 1.00000000 1.00000000 0.22222222 
...
## 1.00000000 1.00000000 0.38636364 0.27272727 0.14285714 1.00000000 0.15384615 0.27777778 0.75000000 0.60606061 0.16470588 0.15542522 1.00000000 0.80000000 
...
\begin{verbatim}
## [[1]]
## + 4/5 vertices, named, from d0a7ca6:
## [1] A D E C
\end{verbatim}
...
\begin{verbatim}
## [[1]]
## + 3/5 vertices, named, from d0a7ca6:
## [1] A B C
\end{verbatim}
...
\begin{verbatim}
##      Mr Hi    Actor 2    Actor 3    Actor 4    Actor 5    Actor 6    Actor 7    Actor 9   Actor 10   Actor 14   Actor 15   Actor 16   Actor 19   Actor 20 
## 0.01523537 0.01552315 0.01938528 0.01886916 0.01581093 0.01667427 0.03091729 0.01884496 0.01729506 0.02746170 0.01523537 0.01523537 0.01523537 0.01701045 
##   Actor 21   Actor 23   Actor 24   Actor 25   Actor 26   Actor 27   Actor 28   Actor 29   Actor 30   Actor 31   Actor 32   Actor 33    Actor 8   Actor 11 
## 0.01523537 0.01523537 0.01523537 0.01523537 0.01935585 0.01523537 0.02484945 0.01798162 0.02141609 0.01939474 0.04512689 0.08402038 0.02351277 0.02484309 
##   Actor 12   Actor 13   Actor 18   Actor 22   Actor 17     John A 
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-124-1.pdf}} \pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-124-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-138-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-140-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-140-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-144-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-145-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-146-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-146-2.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-147-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-148-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-149-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-153-1.pdf}}
...
\begin{verbatim}
## Expected total run time for 1000 sims, using 4 threads is 420 seconds.
\end{verbatim}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-154-1.pdf}}
...
\pandocbounded{\includegraphics[keepaspectratio]{bookdown-demo_files/figure-latex/unnamed-chunk-154-2.pdf}}
